...
namespace NovaEdge.Projectiles{
    public class IceCandleProj : ModProjectile{
        public override string Texture => "Terraria/Item_553";
		...
		public override void AI() {
			...
			if (Main.myPlayer == projectile.owner && projectile.ai[0] == 0f) {
				...
				// If the player stops channeling, do something else. rotation
		...
		public override void Kill(int timeLeft) {
            ...
            for (int i = 0; i < 10; i++) {
				Dust dust = Dust.NewDustDirect(projectile.position - projectile.velocity, projectile.width, projectile.height, 5 , 0, 0, 100, Color.Lime, 0.8f);
				dust.noGravity = true;
				dust.velocity *= 2f;

				dust = Dust.NewDustDirect(projectile.position - projectile.velocity, projectile.width, projectile.height, 5, 0f, 0f, 100, Color.Lime, 0.5f);
            }
        }
    }           
}
